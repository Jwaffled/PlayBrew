...
//
//        BufferedImage tile1 = Utils.loadImageFromPath("TestGame/Tile-CounterTop-F0.png");
//        BufferedImage tile2 = Utils.loadImageFromPath("TestGame/Tile-CounterTop-F1.png");
//        BufferedImage tile3 = Utils.loadImageFromPath("TestGame/Tile-CounterTop-F2.png");
//
//        BufferedImage testTile = Utils.loadImageFromPath("TestGame/Dirt.png");
//
//        player = new Player();
...
//
//        try {
//            effect = new StereoSoundEffect("TestGame/eightbit.wav");
//            effect.getVolumeControl().setValue(currentVolume);
//            bgm = new StereoSoundEffect("TestGame/subwoofer.wav");
//            bgm.getVolumeControl().setValue(currentVolume);
//        } catch(Exception e) {
